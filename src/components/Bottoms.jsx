...
const Bottoms = () => {
    const jeans = products.filter(product => product.category === 'bottom');
  ...
  return (
    ...
    <div>
     ...
     <div className='mb-[40px] mt-[40px] '>
        <h className='bg-[#55422d] mb-5 p-5 text-white font-bold text-2xl grid justify-items-center sm:ml-[30%] sm:mr-[30%] xl:ml-[40%] xl:mr-[40%] rounded-full'>Shop Jeans</h>
     </div>
