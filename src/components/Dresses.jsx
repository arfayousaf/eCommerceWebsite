  ...
  return (
    <div>
        ...
        <ul className='sm:text-md sm:p-2 sm:justify-evenly flex  bg-[#241607] lg:justify-evenly lg:text-2xl text-white lg:font-bold  xl:text-3xl xl:p-4'>
            ...
            <li > <img className='bg-white rounded-full mt-2' src="/cart.jpg"/></li>
     ...
     <div className='mb-[40px] mt-[40px]'>
        <h className='bg-[#55422d] mb-5 p-5 text-white font-bold text-2xl grid justify-items-center sm:ml-[30%] sm:mr-[30%] xl:ml-[40%] xl:mr-[40%] rounded-full'>Shop Dresses</h>
     </div>
